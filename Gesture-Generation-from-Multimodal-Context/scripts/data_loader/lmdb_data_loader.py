...
def word_seq_collate_fn(data):
    ...
    word_seq, text_padded, poses_seq, vec_seq, aux_info = zip(*data)
    ...
    return word_seq, words_lengths, text_padded, poses_seq, vec_seq, aux_info


def default_collate_fn(data):
    _, text_padded, pose_seq, vec_seq, aux_info = zip(*data)
    ...
    return torch.tensor([0]), torch.tensor([0]), text_padded, pose_seq, vec_seq, aux_info
...
class SpeechMotionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        with self.lmdb_env.begin(write=False) as txn:
            ...
            word_seq, pose_seq, vec_seq, aux_info = sample
        ...
        return word_seq_tensor, extended_word_seq, pose_seq, vec_seq, aux_info
